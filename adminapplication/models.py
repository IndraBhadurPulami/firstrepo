...
class EmployeeDetails(models.Model):
	...
	empdeparment=models.CharField(max_length=50)
	...
	def __str__(self):
		return self.empname + " " + str(self.empid) + " " + self.empdesignation + " " + self.empdeparment + " " + str(self.empage) + " " + self.empbloodgroup
